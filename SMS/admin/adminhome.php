    ...
    <div class="collapse navbar-collapse px-2" id="navbarNav">
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown px-5">
			<a class="nav-link dropdown-toggle" href="add_student.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Student</a>
        ...
        <li class="nav-item dropdown px-5">
			<a class="nav-link dropdown-toggle" href="add_course.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Course</a>
			<ul class="dropdown-menu">
...
<center>
    <!-- Tiles -->
        <div class="col-md-3">
            <div class="tile">
                <h3><a href="view_student.php">Student List</a></h3>
                <p></p>
    <!-- Tiles End -->
</div>
</center>
